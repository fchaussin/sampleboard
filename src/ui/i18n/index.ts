...
// Loader i18n minimal + t() (voir specifications.md §3). fr = défaut & fallback.
...
// Registre des tables de traduction. En.json et suivants s'ajouteront ici (voir §3).
 ...
 * Ordre : langue demandée → fallback fr → clé brute (jamais de texte en dur perdu).
 */
